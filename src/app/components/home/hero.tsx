export default function Hero({ dictionary }: { dictionary: any }) {
  return (
    <div className="w-full @container">
      <div className="relative overflow-hidden flex flex-col items-center justify-center text-center min-h-[500px] md:min-h-[600px] bg-cover bg-center gap-8" data-alt="Impresionante vista aérea de los tepuyes venezolanos al amanecer" style={{ backgroundImage: 'linear-gradient(rgba(24, 24, 52, 0.3) 0%, rgba(24, 24, 52, 0.7) 100%), url("/img/salto-angel.webp")' }}>
