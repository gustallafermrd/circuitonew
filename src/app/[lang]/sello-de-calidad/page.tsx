...
export default async function SelloCalidadPage({
  ...
  const t = dictionary.selloDeCalidad;
    ...
    <main className="flex-1">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-20 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h1 className="text-brand-navy text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight">
              {t.hero.title} <br /><span className="text-secondary">{t.hero.titleHighlight}</span> {t.hero.titleEnd}
            </h1>
            ...
            <div className="relative group">
              ...
              <div className="relative w-64 h-64 lg:w-96 lg:h-96 flex items-center justify-center">
                ...
                <div
                  ...
                  <span
                    className="text-brand-navy font-black text-xl lg:text-2xl uppercase leading-tight tracking-tighter">{t.hero.badgeText}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-20 text-center mb-16">
          <h2 className="text-brand-navy text-4xl font-bold mb-4 tracking-tight">{t.managementModel.title}</h2>
          <p className="text-text-muted max-w-2xl mx-auto text-lg leading-relaxed">
            {t.managementModel.subtitle}
          </p>
        </div>
        <div className="max-w-7xl mx-auto px-6 lg:px-20 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div
            ...
            <h3 className="text-primary text-xl font-bold mb-3">{t.managementModel.business.title}</h3>
            <p className="text-text-muted text-sm leading-relaxed">
              {t.managementModel.business.description}
            </p>
          </div>
          <div
            className="group bg-white border border-gray-300 p-8 rounded-3xl hover:border-secondary/50 transition-all duration-300 shadow-soft hover:shadow-xl">
            ...
            <h3 className="text-primary text-xl font-bold mb-3">{t.managementModel.service.title}</h3>
            <p className="text-text-muted text-sm leading-relaxed">
              {t.managementModel.service.description}
            </p>
          </div>
          <div
            className="group bg-white border border-gray-300 p-8 rounded-3xl hover:border-secondary/50 transition-all duration-300 shadow-soft hover:shadow-xl">
            ...
            <h3 className="text-primary text-xl font-bold mb-3">{t.managementModel.facility.title}</h3>
            <p className="text-text-muted text-sm leading-relaxed">
              {t.managementModel.facility.description}
            </p>
          </div>
          <div
            className="group bg-white border border-gray-300 p-8 rounded-3xl hover:border-secondary/50 transition-all duration-300 shadow-soft hover:shadow-xl">
            ...
            <h3 className="text-primary text-xl font-bold mb-3">{t.managementModel.environmental.title}</h3>
            <p className="text-text-muted text-sm leading-relaxed">
              {t.managementModel.environmental.description}
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 grid lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div
              ...
              <p className="text-brand-navy font-bold italic">{t.whyChoose.quote}</p>
              <p className="text-text-muted text-sm mt-2 font-medium">{t.whyChoose.quoteAuthor}</p>
            </div>
          </div>
          <div className="order-1 lg:order-2 space-y-8">
            <h2 className="text-brand-navy text-4xl font-bold tracking-tight">{t.whyChoose.title}</h2>
            <div className="space-y-6">
              <div className="flex gap-4">
                <span className="material-symbols-outlined text-secondary text-3xl shrink-0">check_circle</span>
                <div>
                  <h4 className="text-brand-navy font-bold text-lg">{t.whyChoose.trust.title}</h4>
                  <p className="text-text-muted">{t.whyChoose.trust.description}</p>
                </div>
              </div>
              <div className="flex gap-4">
                <span className="material-symbols-outlined text-secondary text-3xl shrink-0">check_circle</span>
                <div>
                  <h4 className="text-brand-navy font-bold text-lg">{t.whyChoose.security.title}</h4>
                  <p className="text-text-muted">{t.whyChoose.security.description}</p>
                </div>
              </div>
              <div className="flex gap-4">
                <span className="material-symbols-outlined text-secondary text-3xl shrink-0">check_circle</span>
                <div>
                  <h4 className="text-brand-navy font-bold text-lg">{t.whyChoose.sustainable.title}</h4>
                  <p className="text-text-muted">{t.whyChoose.sustainable.description}</p>
                </div>
              </div>
              <div className="flex gap-4">
                <span className="material-symbols-outlined text-secondary text-3xl shrink-0">check_circle</span>
                <div>
                  <h4 className="text-primary font-bold text-lg">{t.whyChoose.unique.title}</h4>
                  <p className="text-text-muted">{t.whyChoose.unique.description}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div
          ...
          <div className="relative z-10">
            <h2 className="text-white text-3xl lg:text-4xl font-bold mb-4">{t.cta.title}</h2>
            <p className="text-gray-300 mb-10 max-w-xl mx-auto text-lg">{t.cta.description}</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <input
                ...
                placeholder={t.cta.emailPlaceholder} type="email" />
              <button
                className="bg-secondary text-white font-black px-8 py-4 rounded-xl hover:bg-secondary/90 transition-all shadow-lg shadow-primary/20">{t.cta.button}</button>
            </div>
          </div>
        </div>
      </section>
